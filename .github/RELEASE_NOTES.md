...
7. **macOS and Terminal UX**: Fixed fullscreen crashes, display races, resize gaps, tab drag state, cursor reflow, links, selection, light-theme readability, and TUI copy.
...
7. **macOS 与终端体验**：修复全屏崩溃和卡住、显示器竞态、resize 缝隙、tab 拖拽残留、光标 reflow、链接、选择、浅色主题可读性和 TUI 复制。
